...
<!---->
 ...
 <section>
    <div class="container" >
        <div class="row ">
          ...
          <div  class="col-sm-12" >
            <h1 class="section_title">Les favoris</h1>
          </div>
        </div>

         <!---item1-->
          <div class="row responsive align-items-center d-flex justify-content-center" >
            <div class="col-sm-3">
               <img  class="col-sm-12 " src="https://drive.google.com/thumbnail?id=1-5OuNZyWuujViP3A7a8uZjYtnCiZekB8" alt="" >
              <h1 class="col-sm-12 slik_title d-flex justify-content-center" >
             Pavé de saumon fumé et citrons confits
            </h1>
 ...
 <section>
    ...
    <div class="row align-items-center ">
    <div class="col-md-6">
      <img class="img_histoire" src="https://drive.google.com/thumbnail?id=1cJNcNHVtzK6GOq_SKmH3d2Meyu-7yDik" alt="">
    </div>
    <div class="col-md-6 histoire_pad">
      <h1 class="section_title">Le meilleur du poisson</h1>
  ...
  <section>
    <div class="container" >
        <div class="row ">
          ...
          <div  class="col-md-12" >
            <h1 class="section_title">#seafood</h1>
          </div>


        <div class="row" >
          <div class="col-sm-3">
             <img  class="col-sm-12 " src="https://drive.google.com/thumbnail?id=1D0yu_-0YPwfLCiipXE547GWL5x_Q_JWQ" alt="" >
          </div>
          <div class="col-sm-3">
            <img  class="col-sm-12 " src="https://drive.google.com/thumbnail?id=1D0yu_-0YPwfLCiipXE547GWL5x_Q_JWQ" alt="" >
         </div>
