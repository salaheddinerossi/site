...
<body>
  ...
  <div class="fixed-top">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                ...
                <div class="justify-contant-center nav2-show nav2-hide">
                ...
                <div class="justify-contant-center nav-hide">
                    <ul class="navbar-nav ml-auto d-flex justify-content-center ">
                        <div class="d-flex">
                            <div class="col-6">
                                <div class="row">
  ...
  <!-- icons -->
    ...
    <div class="v-center d-flex justify-content-center ">
        ...
        <a href="">
            <div class="f-icon">
            <svg class="media-icon1" width="48" height="52" viewBox="0 0 48 52" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="">
        <div class="s-icon">
            <svg class="media-icon1" width="48" height="52" viewBox="0 0 60 42" fill="none" xmlns="http://www.w3.org/2000/svg">
