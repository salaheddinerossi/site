...
<div class="container panier">
        <section class="panier-header">
            <div class="row panier-row1">
                ...
                <div class="col-2 text-center"><h2>Prix/pc</h2></div>
        ...
        <div class="panier-table">
            <div class="row panier-row2">
                <div class="col-2"><p>Pavé de saumon fumé et citrons confits</p><img src="/assets/images/image 7.png" alt=""></div>
                <div class="col-3">
                    <ul>
                ...
                <div class="col-2 text-center"><p>15.00 €</p></div>
                <div class="col-2 text-center"><p>30.00 €</p></div>
