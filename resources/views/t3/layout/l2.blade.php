  ...
  <nav class="navbar navbar-expand-lg navbar-light  static-top">
      <div class="container">
        <a class="navbar-brand" href="#">
              <img style="padding: 20px 0px" src="assets/images/image 10.png" alt="">
            </a>
              ...
              <div class="col-10">
                      <ul class="ul navbar-nav ml-auto ">
                        ...
                        <li class="nav-item as ">
                          <a style="color: white" class="nav-link active" href="#">Accueil
                      ...
                      <div class="col-3">
                        <li class="nav-item as">
                          <a style="color: white" class="nav-link" href="#">Notre histoires</a>
                        </li>
                      </div>
                      <div class="col-2">
                        <li class="nav-item as">
  ...
  @yield('content')
      <footer>
        ...
        <div class="container">
          ...
          <hr>
          <p style="text-align: center; color: #B2923D;;">  Copyright (c) Devcom-Media
          </p>
        </div>
</footer>
